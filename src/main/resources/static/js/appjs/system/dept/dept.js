					...
					.use(
							...
							function() {
								var layer = parent.layer === undefined ? layui.layer
										: top.layer, $ = layui.jquery, treeGrid = layui.treeGrid;
								 ...
								 * return res; }, onClickRow : function(index,
								 * o) { console.log(index, o, "单击！"); //
								 * msg("单击！,按F12，在控制台查看详细参数！"); }, onDblClickRow :
								 * function(index, o) { console.log(index, o,
								 * "双击"); msg("双击！,按F12，在控制台查看详细参数！"); },
								 * onCheck : function(obj, checked, isAll) {//
								 * 复选事件 console.log(obj, checked, isAll, "复选");
								 * msg("复选,按F12，在控制台查看详细参数！"); }, onRadio :
								 * function(obj) {// 单选事件 console.log(obj,
								 * "单选"); msg("单选,按F12，在控制台查看详细参数！"); }
								 */
								});
								/*
								 * function msg(msg) { var loadIndex =
								 * layer.msg(msg, { time : 3000, offset : 'b'//
								 * 顶部 , shade : 0 }); }
								 */
									...
									if (data) {
										...
										if (data.children
											...
											for (var i = 0; i < data.children.length; i++) {
												arr = arr
														.concat(getData(data.children[i]));
											}
										}
									}
									return arr;
